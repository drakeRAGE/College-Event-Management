...
export default function CreateListing() {
    ...
    return (
        <main className='p-8 max-w-5xl mx-auto'>
            <h1 className='text-3xl font-bold text-gray-800 text-center mb-10'>Create New Event</h1>
                        ...
                        <div className='space-y-5'>
                            ...
                            <div className='grid sm:grid-cols-2 gap-4'>
                                <div>
                                    ...
                                    <input
                                        type="date"
                                        className='w-full px-4 py-3 rounded-lg bg-gray-300 border border-gray-300 focus:outline-none focus:border-green-500'
                                        onChange={handleChange}
