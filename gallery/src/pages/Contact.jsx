...
const Contact = () => {
    ...
    return (
        <div>
            <section className="bg-gradient-to-r from-rgb(17 24 39) via-rgb(17 24 39) to-rgb(17 24 39) dark:from-gray-700 dark:via-gray-800 dark:to-gray-900 ">
                        ...
                        <div className="text-white lg:w-1/2 lg:mx-6">
                            ...
                            <div className="mt-6 space-y-8 md:mt-8">
                                ...
                                <p className="flex items-start -mx-2">
                                    ...
                                    <span className="mx-2 text-white truncate w-72">crashbrown2004@gmail.com</span>
                                </p>
                            </div>
                            ...
                            <div className="mt-6 md:mt-8">
                                ...
                                <div className="flex mt-4 -mx-1.5 ">
                                    ...
                                    <a className="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500" href="https://www.linkedin.com/in/deepak-joshi-49261923b">
                                    ...
                                    <a className="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500" href="https://www.instagram.com/user/deepak_joshi_4517/">
                                        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                                ...
                                <form className="mt-4">
                                    ...
                                    <div className="w-full mt-6">
                                        <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200" value={message} onChange={handleChange} >Message</label>
                                    ...
                                    <button className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">
                                        <Link to={`mailto:crashbrown2004@gmail.com?subject=Regarding Deepak&body=${message}`}>get in touch</Link>
                                    </button>
                                </form>
                            </div>
                        </div>
...
//   return (
//     <div>
//       <section className="min-h-screen bg-rgb(17 24 39) dark:bg-gray-900">
