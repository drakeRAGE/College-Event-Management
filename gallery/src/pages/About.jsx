  ...
  return (
    <div className='min-h-screen py-24 px-4 max-w-6xl mx-auto'>
      ...
      <p className='mb-6 text-lg text-slate-700 leading-relaxed'>
        Welcome to GBPUAT's comprehensive event Registration platform. Our system serves as the central hub for all university events, making it easier for students and faculty to stay connected with campus activities. From academic seminars to cultural festivals, we ensure that every university event is properly documented and easily accessible.
      </p>
      <p className='mb-6 text-lg text-slate-700 leading-relaxed'>
      ...
      {/* <p className='mb-6 text-md text-slate-700 leading-relaxed'>
        Our event Registration system features an intuitive interface that allows you to easily browse through different categories of events. Each event listing provides comprehensive details including venue information, timings, registration requirements, and contact details of organizers. Students and faculty can access event materials, view photo galleries, and stay updated with any schedule changes or announcements.
      </p>
      <p className='mb-6 text-md text-slate-700 leading-relaxed'>
        Experience the dynamic academic and cultural environment of GBPUAT through our extensive event coverage. From departmental seminars and research symposiums to annual festivals and sports competitions, our platform captures the essence of university life. Stay connected with the latest happenings and be part of the university's growing digital community.
      </p> */}
    </div>
  );
}
